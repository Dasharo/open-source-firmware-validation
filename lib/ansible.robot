...
Run Ansible Playbook On Supported Operating Systems
    ...
    ...    Suite. Argument ${runned_suite_name} should point to the suite setup
    ...
    ELSE
        IF    '${ANSIBLE_SUPPORT}' == '${TRUE}'
            IF    '${TESTS_IN_UBUNTU_SUPPORT}' == '${TRUE}'
                ...
                ...    ${CURDIR}${/}..${/}ansible-roles${/}roles${/}${runned_suite_name}${/}tasks${/}common.yml
