...
PSF001.001 Check Power State After Power Failure default state (firmware)
    ...
    ${state}=    Get Option State    ${me_menu}    Power state after
...
PSF002.001 Powered Off State Restoration Test
    ...
    ${dasharo_menu}=    Enter Dasharo System Features    ${setup_menu}
    ${me_menu}=    Enter Dasharo Submenu    ${dasharo_menu}    Power Management Options
    Set Option State    ${me_menu}    Power state after    Powered Off
...
PSF003.001 Powered On State Restoration Test
    ...
    ${dasharo_menu}=    Enter Dasharo System Features    ${setup_menu}
    ${me_menu}=    Enter Dasharo Submenu    ${dasharo_menu}    Power Management Options
    Set Option State    ${me_menu}    Power state after    Powered On
    Save Changes And Reset    2    4
    Enter Setup Menu Tianocore
    Simulate Power Failure
    Enter Setup Menu Tianocore
...
PSF004.001 Previous Power State Restoration Test - Powered Off
    ...
    ${dasharo_menu}=    Enter Dasharo System Features    ${setup_menu}
    ${me_menu}=    Enter Dasharo Submenu    ${dasharo_menu}    Power Management Options
    Set Option State    ${me_menu}    Power state after    The state at the moment of power failure
    Save Changes And Reset    2    4
    Enter Setup Menu Tianocore
