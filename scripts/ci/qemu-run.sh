...
if [ ! -f "OVMF_CODE.fd" ] || [ ! -f "OVMF_VARS.fd" ]; then
    ...
    wget -O ./OVMF_CODE.fd https://cloud.3mdeb.com/index.php/s/7DxNdXsoF8iGonN/download/OVMF_CODE.fd
    wget -O ./OVMF_VARS.fd https://cloud.3mdeb.com/index.php/s/MG64AcCrFFmgKwt/download/OVMF_VARS.fd
else
