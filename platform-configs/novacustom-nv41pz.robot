...
&{UPP_CRAFTY_BENCHMARK}    name=crafty    score=7480997    scale=higher_is_better    dev=0.2    type=singlecore
&{UPP_CACHEBENCH_BENCHMARK}    name=cachebench    score=75584.7    scale=higher_is_better    dev=0.2    type=multicore
