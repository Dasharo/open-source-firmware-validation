...
${CLEVO_DISK}=                                      Samsung Electronics Co Ltd NVMe SSD Controller 980
${DEVICE_USB_KEYBOARD}=                             Dell
