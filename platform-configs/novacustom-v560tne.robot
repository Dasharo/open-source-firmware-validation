...
${SENSORS_CONFIG_FILE}=                             include/sensors/novacustom-v560tne-sensors-config.yaml
${CUSTOM_FAN_CURVE_FILE}=                           include/sensors/novacustom-v560tne-fan-curve-config.yaml
