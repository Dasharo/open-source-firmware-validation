...
&{UPP_CRAFTY_BENCHMARK}    name=crafty    score=9224291    scale=higher_is_better    dev=0.2    type=singlecore
&{UPP_CACHEBENCH_BENCHMARK}    name=cachebench    score=104565.1    scale=higher_is_better    dev=0.2    type=multicore
